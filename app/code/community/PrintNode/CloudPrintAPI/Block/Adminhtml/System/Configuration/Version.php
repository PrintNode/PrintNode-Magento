 ...
 */
class PrintNode_CloudPrintAPI_Block_Adminhtml_System_Configuration_Version extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
     * Get element html
     *
    ...
    {
        return (string)Mage::helper('pncloudprintapi')->getExtensionVersion();
    }
}
